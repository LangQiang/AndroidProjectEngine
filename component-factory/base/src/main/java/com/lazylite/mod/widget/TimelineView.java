...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarker = typedArray.getDrawable(R.styleable.TimelineView_time_marker);
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.TimelineView_time_markerSize, ScreenUtility.dip2px(20));
        mMarkerPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.TimelineView_time_markerPaddingLeft, 0);
        mMarkerPaddingTop = typedArray.getDimensionPixelSize(R.styleable.TimelineView_time_markerPaddingTop, 0);
        mMarkerPaddingRight = typedArray.getDimensionPixelSize(R.styleable.TimelineView_time_markerPaddingRight, 0);
        mMarkerPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.TimelineView_time_markerPaddingBottom, 0);
        mMarkerInCenter = typedArray.getBoolean(R.styleable.TimelineView_time_markerInCenter, true);
        mStartLineColor = typedArray.getColor(R.styleable.TimelineView_time_startLineColor, getResources().getColor(android.R.color.darker_gray));
        mEndLineColor = typedArray.getColor(R.styleable.TimelineView_time_endLineColor, getResources().getColor(android.R.color.darker_gray));
        mLineWidth = typedArray.getDimensionPixelSize(R.styleable.TimelineView_time_lineWidth, ScreenUtility.dip2px(2));
        mLineOrientation = typedArray.getInt(R.styleable.TimelineView_time_lineOrientation, LineOrientation.VERTICAL);
        mLinePadding = typedArray.getDimensionPixelSize(R.styleable.TimelineView_time_linePadding, 0);
        mLineStyle = typedArray.getInt(R.styleable.TimelineView_time_lineStyle, LineStyle.NORMAL);
        mLineStyleDashLength = typedArray.getDimensionPixelSize(R.styleable.TimelineView_time_lineStyleDashLength, ScreenUtility.dip2px(4f));
        mLineStyleDashGap = typedArray.getDimensionPixelSize(R.styleable.TimelineView_time_lineStyleDashGap, ScreenUtility.dip2px(4f));
        typedArray.recycle();
        ...
        if(mMarker == null) {
            mMarker = getResources().getDrawable(R.drawable.base_oval_blue);
        }
