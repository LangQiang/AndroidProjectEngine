...
public class FixFlingScrollBehavior extends AppBarLayout.Behavior {
    ...
    public FixFlingScrollBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, AppBarLayout child, MotionEvent ev) {
        Timber.d("onInterceptTouchEvent:" + child.getTotalScrollRange());
    ...
    private Field getFlingRunnableField() throws NoSuchFieldException {
        ...
        try {
            ...
            if (superclass != null) {
                ...
                Timber.d("AppBarLayout.Behavior父类" + name);
                headerBehaviorType = superclass.getSuperclass();
            }
            if (headerBehaviorType != null) {
                String name = headerBehaviorType.getName();
                Timber.d("AppBarLayout.Behavior父类的父类1" + name);
            ...
            if (headerBehaviorType != null) {
                String name = headerBehaviorType.getName();
                Timber.d("AppBarLayout.Behavior父类的父类2" + name);
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout,
        ...
        Timber.d("onNestedPreScroll:" + child.getTotalScrollRange()
     ...
     */
    @Override
    public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, AppBarLayout child,
                               View target, int dxConsumed, int dyConsumed, int
                                       dxUnconsumed, int dyUnconsumed, int type) {
        Timber.d("onNestedScroll: target:" + target.getClass() + " ,"
